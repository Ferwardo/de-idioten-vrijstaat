---
label: De Idiotengrondwet van de Vrijstaat
sidebar_position: 1
---

export var articleNumber = 0
export const article = ()=>{
    articleNumber++
    return <div> Art. {articleNumber} </div>
}
export const articleBis = ()=>{
    return <div> Art. {articleNumber}bis </div>
}
export const articleTer = ()=>{
    return <div> Art. {articleNumber}ter </div>
}
export const articleQuater = ()=>{
    return <div> Art. {articleNumber}quater </div>
}

# De Idiotengrondwet van de Vrijstaat
